...
import { idlFactory } from './attendly.did.js';
export { idlFactory } from './attendly.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ATTENDLY_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./attendly.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the attendly canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./attendly.did.js")._SERVICE>}
 */
export const attendly = createActor(canisterId);

...
import { idlFactory } from './attendly_landing.did.js';
export { idlFactory } from './attendly_landing.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ATTENDLY_LANDING_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./attendly_landing.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the attendly_landing canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./attendly_landing.did.js")._SERVICE>}
 */
export const attendly_landing = createActor(canisterId);
